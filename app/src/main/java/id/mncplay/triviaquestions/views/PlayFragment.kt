...
class PlayFragment : RxBaseFragment() {
    ...
    private fun initData(){
        ...
        val params_wrong = progress_wrong.layoutParams
        params_wrong.height = Utils.count_wrong * 24
        progress_wrong.layoutParams = params_wrong
    ...
    private fun updateData(id:String,username:String, score:String){
        ...
        subscriptions.add(providUpdateService().scoreUpdate(data)
            ...
            .subscribe({
                ...
                loading?.dismiss()
                val builder = AlertDialog.Builder(context)
                builder.setMessage("Failed Update Score User : "+err.localizedMessage).setNegativeButton("OK", dialogClickListener).show()
